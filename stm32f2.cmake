...
SET(LINKER_SCRIPT ${CMAKE_SOURCE_DIR}/stm32f2.ld)
...
SET(DEFINES "-DBUILDING_BOOTLOADER -DSTM32F205xx -DBOOT_STM32F2 -DTX_WITH_CANDB=1 -D__weak='__attribute__((weak))' -D__packed='__attribute__((__packed__))'")
